...
urlpatterns = [
    ...
    path('p/eliminar/<int:grupo_id>/', vistas_principal.eliminar_grupo, name='p_eliminar_grupo'),
    path('p/eliminar/grupos/<int:grupo_id>/', vistas_principal.eliminar_grupos, name='p_eliminar_grupos'),
