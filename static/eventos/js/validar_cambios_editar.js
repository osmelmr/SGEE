document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- Nueva lógica para deshabilitar campos según la fecha actual ---
    function controlarEdicionFechasHoras() {
        const hoy = new Date();
        ...
        // Si la fecha actual es mayor que la fecha de inicio, deshabilitar fecha de inicio
        ...
        // Si la fecha actual es mayor que la fecha de fin, deshabilitar fecha de fin
        if (fin && hoy > fin) {
        ...
        // Si la fecha actual es mayor que ambas fechas, deshabilitar horas
    ...
    // Ejecutar al cargar y cuando cambian fechas
    controlarEdicionFechasHoras();
    fechaInicio.addEventListener('change', controlarEdicionFechasHoras);
    fechaFin.addEventListener('change', controlarEdicionFechasHoras);
